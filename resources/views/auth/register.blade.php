...
<head>
    ...
    <meta name="description" content="Create a free account on Deadline Panic Tracker — stop panicking, start tracking.">
    <title>Register — Deadline Panic Tracker</title>
    ...
    <div class="left-panel">
        ...
        <div class="left-content">
            <h1 class="left-headline">
                Get in<br>
                <span class="accent-orange">control.</span><br>
                Beat the <span class="accent-red">deadline.</span>
            </h1>
            <p class="left-sub">
                Create an account to start tracking tasks, mapping urgency levels, and conquering your work schedule without the stress.
            </p>
